...
// Fonction pour vérifier le solde et afficher dans le modal
function verifierSolde() {
    if (currentUser) {
        document.getElementById('soldeMessage').textContent = `Votre solde actuel est de ${currentUser.solde} Fcfa.`;
